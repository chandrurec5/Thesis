...
\begin{tikzpicture}[scale=1]
    ...
    \addplot[smooth,black] plot file {mfile/fproj.dat};
    \addplot[dashed,black] plot file {mfile/f1.dat};
    \addplot[dashed,black] plot file {mfile/f2.dat};
    \addplot[dashed,black] plot file {mfile/f3.dat};
    \addplot[dashed,black] plot file {mfile/f4.dat};
    \addplot[dashed,black] plot file {mfile/f5.dat};
